...
function(t, i, e) {
	...
	var s = e.static,
		...
		r = laya.filters.ColorFilter,
		a = laya.utils.Ease,
		c = laya.events.Event,
		u = laya.display.css.Font,
	...
	var k = function() {
		...
		L = function() {
			...
			return h(t, "laya.ui.UIUtils"), t.fillArray = function(t, i, e) {
				...
				if (i) for (var h = i.split(","), n = 0, o = Math.min(s.length, h.length); n < o; n++) {
					var l = h[n];
					s[n] = "true" == l || "false" != l && l, null != e && (s[n] = e(l))
				}
				return s
			}, t.toColor = function(t) {
				return x.toHexColor(t)
			}, t.gray = function(i, e) {
				void 0 === e && (e = !0), e ? t.addFilter(i, t.grayFilter) : t.clearFilter(i, r)
				...
				return this.grayFilter = new r([.3086, .6094, .082, 0, 0, .3086, .6094, .082, 0, 0, .3086, .6094, .082, 0, 0, 0, 0, 0, 1, 0])
			...
			return s.destroy = function() {
				...
				if (t && t.bitmap) {
					...
					if (!h || n === e && o === s) this.cleanByTexture(t, this._offset ? this._offset[0] : 0, this._offset ? this._offset[1] : 0, e, s);
						...
						var l = t.$_GID + "." + e + "." + s + "." + h.join(".");
						if (B.I.get(l)) return void(this.cmds = B.I.get(l));
						this.clear();
						var r = h[0],
							a = h[1],
							c = h[2],
							...
							_ = h[4],
							d = !1;
						if (e == n && (u = a = 0), s == o && (r = c = 0), u + a > e) {
							var f = e;
							d = !0, e = u + a
						}
						d && (this.save(), this.clipRect(0, 0, f, s)), u && r && this.drawTexture(i.getTexture(t, 0, 0, u, r), 0, 0, u, r), a && r && this.drawTexture(i.getTexture(t, n - a, 0, a, r), e - a, 0, a, r), u && c && this.drawTexture(i.getTexture(t, 0, o - c, u, c), 0, s - c, u, c), a && c && this.drawTexture(i.getTexture(t, n - a, o - c, a, c), e - a, s - c, a, c), r && this.drawBitmap(_, i.getTexture(t, u, 0, n - u - a, r), u, 0, e - u - a, r), c && this.drawBitmap(_, i.getTexture(t, u, o - c, n - u - a, c), u, s - c, e - u - a, c), u && this.drawBitmap(_, i.getTexture(t, 0, r, u, o - r - c), 0, r, u, s - r - c), a && this.drawBitmap(_, i.getTexture(t, n - a, r, a, o - r - c), e - a, r, a, s - r - c), this.drawBitmap(_, i.getTexture(t, u, r, n - u - a, o - r - c), u, r, e - u - a, s - r - c), d && this.restore(), this.autoCacheCmd && !v.isConchApp && B.I.set(l, this.cmds)
					}
					this._repaint()
				}
				...
				var n = t.$_GID + "." + i + "." + e + "." + s + "." + h,
					o = B.I.get(n);
				return o || (o = S.createFromTexture(t, i, e, s, h), B.I.set(n, o)), o
			}, i
		}(d),
		T = (function(t) {
			function i() {
			...
			return e.imps(s, {
			...
			}), n(0, s, "scaleY", t.prototype._$get_scaleY, function(i) {
				t.prototype._$get_scaleY.call(this) != i && (t.prototype._$set_scaleY.call(this, i), this.callLater(this.changeSize), this._layout.enable && this.resetLayoutY())
				...
				return t
			}), n(0, s, "scaleX", t.prototype._$get_scaleX, function(i) {
				t.prototype._$get_scaleX.call(this) != i && (t.prototype._$set_scaleX.call(this, i), this.callLater(this.changeSize), this._layout.enable && this.resetLayoutX())
			}), n(0, s, "top", function() {
		...
		P = function(t) {
			...
			return s._closeOnSide = function() {
				...
				void 0 === i && (i = !1), i && this._closeAll(), t.popupCenter && this._centerDialog(t), this.addChild(t), (t.isModal || this._$P.hasZorder) && this.timer.callLater(this, this._checkMask), e && null != t.popupEffect ? t.popupEffect.runWith(t) : this.doOpen(t), this.event("open")
			}, s.doOpen = function(t) {
				t.onOpened()
			}, s.lock = function(t) {
				this.lockLayer && (t ? this.addChild(this.lockLayer) : this.lockLayer.removeSelf())
			}, s.close = function(t, i, e) {
				e && null != t.closeEffect ? t.closeEffect.runWith([t, i]) : this.doClose(t, i), this.event("close")
		...
		N = function(t) {
			...
			return e.imps(o, {
				...
				if (t) {
					...
					var s = t.$_GID + "-" + this._stateNum,
						h = B.I.get(s);
					if (h) this._sources = h;
					else {
						if (this._sources = [], 1 === this._stateNum) this._sources.push(t);
						else for (var n = 0; n < this._stateNum; n++) this._sources.push(S.createFromTexture(t, 0, e * n, i, e));
			...
			}), n(0, o, "width", t.prototype._$get_width, function(i) {
				t.prototype._$set_width.call(this, i), this._autoSize && (this._bitmap.width = i, this._text && (this._text.width = i))
			}), n(0, o, "height", t.prototype._$get_height, function(i) {
				t.prototype._$set_height.call(this, i), this._autoSize && (this._bitmap.height = i, this._text && (this._text.height = i))
			}), n(0, o, "dataSource", t.prototype._$get_dataSource, function(i) {
				this._dataSource = i, "number" == typeof i || "string" == typeof i ? this.label = i + "" : t.prototype._$set_dataSource.call(this, i)
		...
		Y = function(t) {
			function i(t, e, s) {
				this._sources = null, this._bitmap = null, this._skin = null, this._clipX = 1, this._clipY = 1, this._clipWidth = 0, this._clipHeight = 0, this._autoPlay = !1, this._interval = 50, this._complete = null, this._isPlaying = !1, this._index = 0, this._clipChanged = !1, this._group = null, i.__super.call(this), void 0 === e && (e = 1), void 0 === s && (s = 1), this._clipX = e, this._clipY = s, this.skin = t
			}
			h(i, "laya.ui.Clip", t);
			var s = i.prototype;
			return s.destroy = function(i) {
				...
				if (t === this._skin && i) {
					var e = this._clipWidth || Math.ceil(i.sourceWidth / this._clipX),
						...
						h = this._skin + e + s,
						n = B.I.get(h);
					if (n) this._sources = n;
					else {
						this._sources = [];
						for (var o = 0; o < this._clipY; o++) for (var l = 0; l < this._clipX; l++) this._sources.push(S.createFromTexture(i, e * l, s * o, e, s));
						B.I.set(h, this._sources)
					}
					this.index = this._index, this.event("loaded"), this.onCompResize()
				}
			}, s.play = function() {
				this._isPlaying = !0, this.index = 0, this._index++, e.timer.loop(this.interval, this, this._loop), this.on("display", this, this._onDisplay), this.on("undisplay", this, this._onDisplay)
			}, s._loop = function() {
				this._style.visible && this._sources && (this.index = this._index, this._index++, this._index >= this._sources.length && (this._index = 0))
			}, s.stop = function() {
				this._isPlaying = !1, e.timer.clear(this, this._loop)
			...
			}), n(0, s, "width", t.prototype._$get_width, function(i) {
				t.prototype._$set_width.call(this, i), this._bitmap.width = i
			}), n(0, s, "height", t.prototype._$get_height, function(i) {
				t.prototype._$set_height.call(this, i), this._bitmap.height = i
			}), n(0, s, "measureWidth", function() {
				...
				this._isPlaying = t
			}), n(0, s, "dataSource", t.prototype._$get_dataSource, function(i) {
				this._dataSource = i, "number" == typeof i && Math.floor(i) == i || "string" == typeof i ? this.index = parseInt(i) : t.prototype._$set_dataSource.call(this, i)
			...
			return s.destroy = function(i) {
				...
				for (var i = [0, 3355443, 6710886, 10066329, 13421772, 16777215, 16711680, 65280, 255, 16776960, 65535, 16711935], e = 0; e < 12; e++) for (var s = 0; s < 20; s++) {
					...
					var o = s * this._gridSize,
						l = e * this._gridSize;
					t.drawRect(o, l, this._gridSize, this._gridSize, n, "#000000")
				}
		...
		O = function(t) {
			...
			return s.destroy = function(i) {
				...
				t.prototype._$set_width.call(this, i), this._button.width = this._width, this._itemChanged = !0, this._listChanged = !0
				...
				t.prototype._$set_height.call(this, i), this._button.height = this._height
				...
				if (this._isOpen != t) if (this._isOpen = t, this._button.selected = this._isOpen, this._isOpen) {
					...
					s = s + this._listHeight <= e.stage.height ? s : i.y - this._listHeight, this._list.pos(i.x, s), this._list.zOrder = 1001, e._currentStage.addChild(this._list), e.stage.once("mousedown", this, this.removeList), this._list.selectedIndex = this._selectedIndex
				...
				this._dataSource = i, "number" == typeof i && Math.floor(i) == i || "string" == typeof i ? this.selectedIndex = parseInt(i) : i instanceof Array ? this.labels = i.join(",") : t.prototype._$set_dataSource.call(this, i)
		...
		X = function(t) {
			...
			return s.destroy = function(i) {
				...
				this.addChild(this.slider = new $), this.addChild(this.upButton = new N), this.addChild(this.downButton = new N)
			}, s.initialize = function() {
				...
				this.upButton.visible = this._showButtons, this.downButton.visible = this._showButtons, this._showButtons && (this.upButton.skin = this._skin.replace(".png", "$up.png"), this.downButton.skin = this._skin.replace(".png", "$down.png")), this.slider.isVertical ? this.slider.y = this._showButtons ? this.upButton.height : 0 : this.slider.x = this._showButtons ? this.upButton.width : 0, this.resetPositions()
			}, s.changeSize = function() {
				t.prototype.changeSize.call(this), this.resetPositions(), this.event("change"), this.changeHandler && this.changeHandler.runWith(this.value)
				...
				if (e.stage.off("mouseup", this, this.onStageMouseUp2), e.stage.off("mouseout", this, this.onStageMouseUp2), e.timer.clear(this, this.loop), !this._clickOnly) if (this._target.mouseEnabled = !0, this._isElastic) this._value < this.min ? w.to(this, {
					value: this.min
				...
				this._dataSource = i, "number" == typeof i || "string" == typeof i ? this.value = Number(i) : t.prototype._$set_dataSource.call(this, i)
		...
		$ = function(t) {
			...
			return o.destroy = function(i) {
				...
				if (this._skin != t) {
					...
					g.getRes(i) && (this._progress || (this.addChild(this._progress = new E), this._progress.sizeGrid = this._bar.sizeGrid, this.setChildIndex(this._progress, 1)), this._progress.skin = i), this.setBarPoint(), this.callLater(this.changeValue)
				}
		...
		E = function(t) {
			...
			return s.destroy = function(i) {
				...
				this._dataSource = i, "string" == typeof i ? this.skin = i : t.prototype._$set_dataSource.call(this, i)
			}), n(0, s, "measureHeight", function() {
				...
				t.prototype._$set_width.call(this, i), this._bitmap.width = 0 == i ? 1e-7 : i
			}), n(0, s, "height", t.prototype._$get_height, function(i) {
				t.prototype._$set_height.call(this, i), this._bitmap.height = 0 == i ? 1e-7 : i
			}), i
		}(T),
		V = function(t) {
			function i(t) {
			...
			return e.destroy = function(i) {
			...
			}), n(0, e, "italic", function() {
				return this._tf.italic
			}, function(t) {
				this._tf.italic = t
			}), n(0, e, "wordWrap", function() {
				...
				this._tf.font = t
			}), n(0, e, "dataSource", t.prototype._$get_dataSource, function(i) {
				this._dataSource = i, "number" == typeof i || "string" == typeof i ? this.text = i + "" : t.prototype._$set_dataSource.call(this, i)
			}), n(0, e, "color", function() {
				return this._tf.color
			}, function(t) {
				this._tf.color = t
			}), n(0, e, "valign", function() {
				return this._tf.valign
			}, function(t) {
				this._tf.valign = t
			}), n(0, e, "leading", function() {
				return this._tf.leading
			}, function(t) {
				this._tf.leading = t
			}), n(0, e, "fontSize", function() {
			...
			}), n(0, e, "stroke", function() {
				return this._tf.stroke
			}, function(t) {
				this._tf.stroke = t
			}), n(0, e, "strokeColor", function() {
				return this._tf.strokeColor
			}, function(t) {
				this._tf.strokeColor = t
			}), n(0, e, "textField", function() {
				return this._tf
			}), n(0, e, "measureWidth", function() {
				return this._tf.width
			}), n(0, e, "measureHeight", function() {
				return this._tf.height
			}), n(0, e, "width", function() {
				return this._width || this._tf.text ? t.prototype._$get_width.call(this) : 0
			}, function(i) {
				t.prototype._$set_width.call(this, i), this._tf.width = i
			}), n(0, e, "height", function() {
				return this._height || this._tf.text ? t.prototype._$get_height.call(this) : 0
			}, function(i) {
				t.prototype._$set_height.call(this, i), this._tf.height = i
			}), n(0, e, "overflow", function() {
				return this._tf.overflow
			}, function(t) {
				this._tf.overflow = t
			}), n(0, e, "underline", function() {
				return this._tf.underline
			}, function(t) {
				this._tf.underline = t
			}), n(0, e, "underlineColor", function() {
		...
		D = function(t) {
			...
			return e.destroy = function(i) {
			...
			}), n(0, e, "height", t.prototype._$get_height, function(i) {
				t.prototype._$set_height.call(this, i), this._bg.height = this._height, this._bar.height = this._height
			}), n(0, e, "bar", function() {
				return this._bar
				...
				return this._bg
			}), n(0, e, "sizeGrid", function() {
				return this._bg.sizeGrid
			}, function(t) {
				this._bg.sizeGrid = this._bar.sizeGrid = t
			}), n(0, e, "width", t.prototype._$get_width, function(i) {
				t.prototype._$set_width.call(this, i), this._bg.width = this._width, this.callLater(this.changeValue)
			}), n(0, e, "dataSource", t.prototype._$get_dataSource, function(i) {
				this._dataSource = i, "number" == typeof i || "string" == typeof i ? this.value = Number(i) : t.prototype._$set_dataSource.call(this, i)
			}), i
		}(T),
		R = (function(t) {
			...
			function i() {
				this._idMap = null, this._aniList = null, i.__super.call(this)
			}
			h(i, "laya.ui.View", H);
			var n = i.prototype;
			return n.createView = function(t) {
				...
				void 0 === t && (t = !0), this._aniList && (this._aniList.length = 0), this._idMap = null, this._aniList = null, laya.ui.Component.prototype.destroy.call(this, t)
			}, i._regs = function() {
				var t;
				for (t in i.uiClassMap) l.regClass(t, i.uiClassMap[t])
			}, i.createComp = function(t, s, h) {
				if (!(s = s || i.getCompInstance(t))) return console.warn("can not create:" + t.type), null;
				var n = t.child;
				if (n) for (var o = 0, r = n.length; o < r; o++) {
					var a = n[o];
					if (!s.hasOwnProperty("itemRender") || "render" != a.props.name && "render" !== a.props.renderType) if ("Graphic" == a.type) l.addGraphicsToSprite(a, s);
					else if (l.isDrawType(a.type)) l.addGraphicToSprite(a, s, !0);
					else {
						var c = i.createComp(a, null, h);
						"Script" == a.type ? "owner" in c ? c.owner = s : "target" in c && (c.target = s) : "mask" == a.props.renderType || "mask" == a.props.name ? s.mask = c : c instanceof laya.display.Sprite && s.addChild(c)
					} else s.itemRender = a
				}
				var u = t.props;
				for (var _ in u) {
					var d = u[_];
					i.setCompValue(s, _, d, h)
				}
				return e.__typeof(s, "laya.ui.IItem") && s.initItems(), t.compId && h && h._idMap && (h._idMap[t.compId] = s), s
			}, i.setCompValue = function(t, i, e, s) {
				"var" === i && s ? s[e] = t : t[i] = "true" === e || "false" !== e && e
				...
				i.viewClassMap[t] = e
			}, i.uiMap = {}, i.viewClassMap = {}, s(i, ["uiClassMap", function() {
		...
		G = function(t) {
			...
			return e.preinitialize = function() {
				...
				this._dataSource = i, "boolean" == typeof i ? this.selected = i : "string" == typeof i ? this.selected = "true" === i : t.prototype._$set_dataSource.call(this, i)
			}), i
		}(N),
		W = function(t) {
			function i() {
		...
		F = function(t) {
			...
			return e.createChildren = function() {
				...
				t.prototype._$set_height.call(this, i), this.callLater(this.changeValue)
			}), n(0, e, "direction", function() {
				...
				t.prototype._$set_width.call(this, i), this.callLater(this.changeValue)
		...
		U = function(t) {
			...
			return e.imps(s, {
				...
				this._$P.cacheAs || (this._$P.cacheAs = t.prototype._$get_cacheAs.call(this)), t.prototype._$set_cacheAs.call(this, "none"), this._scrollBar.once("end", this, this.onScrollEnd)
				...
				if (this.cacheContent) {
					var l = new H;
					l.cacheAsBitmap = !0, l.pos((this._isVertical ? 0 : t) * n, (this._isVertical ? t : 0) * o), this._content.addChild(l), this._content.optimizeScrollRect = !0, s = l
				} else {
					for (var r = [], a = this._cells.length - 1; a > -1; a--) {
						var c = this._cells[a];
						c.removeSelf(), r.push(c)
					}
					this._cells.length = 0
				}
				for (var u = t; u < e; u++) for (var _ = 0; _ < i; _++)(h = r && r.length ? r.pop() : this.createItem()).x = (this._isVertical ? _ : u) * n - s.x, h.y = (this._isVertical ? u : _) * o - s.y, h.name = "item" + (u * i + _), s.addChild(h), this.addCell(h)
			}, s.createItem = function() {
				return "function" == typeof this._itemRender ? new this._itemRender : R.createComp(this._itemRender)
				...
				this._content.width = t, this._content.height = i, (this._scrollBar || 0 != this._offset.x || 0 != this._offset.y) && (this._content.scrollRect || (this._content.scrollRect = new y), this._content.scrollRect.setTo(-this._offset.x, -this._offset.y, t, i), this._content.conchModel && this._content.conchModel.scrollRect(-this._offset.x, -this._offset.y, t, i)), this.event("resize")
				...
				if (this.cacheContent) o = s + 1, this._createdLine - h < o && (this._createItems(this._createdLine, e, this._createdLine + o), this.renderItems(this._createdLine * e, 0), this._createdLine += o);
					...
					if (n > this._startIndex) {
						...
						var l = !0,
							r = this._startIndex + e * (s + 1);
						this._isMoved = !0
					} else n < this._startIndex && (o = this._startIndex - n, l = !1, r = this._startIndex - 1, this._isMoved = !0);
					for (var a = 0; a < o; a++) {
						if (l) {
							var c = this._cells.shift();
							this._cells[this._cells.length] = c;
							var u = r + a
						} else c = this._cells.pop(), this._cells.unshift(c), u = r - a;
				...
				this._isVertical ? (d.y = i - this._offset.y, d.x = -this._offset.x) : (d.y = -this._offset.y, d.x = i - this._offset.x), this._content.conchModel && this._content.conchModel.scrollRect(d.x, d.y, d.width, d.height), this.repaint()
				...
				this._array && i >= 0 && i < this._array.length ? (t.visible = !0, t.dataSource = this._array[i], this.cacheContent || this.posCell(t, i), this.hasListener("render") && this.event("render", [t, i]), this.renderHandler && this.renderHandler.runWith([t, i])) : (t.visible = !1, t.dataSource = null)
			}, s.refresh = function() {
				...
				this.runCallLater(this.changeCells)
			}, n(0, s, "cacheAs", t.prototype._$get_cacheAs, function(i) {
				t.prototype._$set_cacheAs.call(this, i), this._scrollBar && (this._$P.cacheAs = null, "none" !== i ? this._scrollBar.on("start", this, this.onScrollStart) : this._scrollBar.off("start", this, this.onScrollStart))
			}), n(0, s, "content", function() {
				return this._content
			}), n(0, s, "height", t.prototype._$get_height, function(i) {
				i != this._height && (t.prototype._$set_height.call(this, i), this._setCellChanged())
				...
				i != this._width && (t.prototype._$set_width.call(this, i), this._setCellChanged())
				...
				this._dataSource = i, "number" == typeof i && Math.floor(i) == i || "string" == typeof i ? this.selectedIndex = parseInt(i) : i instanceof Array ? this.array = i : t.prototype._$set_dataSource.call(this, i)
		...
		j = function(t) {
			function i() {
				this._content = null, this._vScrollBar = null, this._hScrollBar = null, this._scrollChanged = !1, i.__super.call(this), this.width = this.height = 100, this._content.optimizeScrollRect = !0
			}
			h(i, "laya.ui.Panel", t);
			var e = i.prototype;
			return e.destroy = function(t) {
				...
				var t = this.contentWidth || 1,
					...
					l = n ? this._height - s.height : this._height;
				...
				var e = this._content;
				e.width = t, e.height = i, e.scrollRect || (e.scrollRect = new y), e.scrollRect.setTo(0, 0, t, i), e.conchModel && e.conchModel.scrollRect(0, 0, t, i)
			}, e.onScrollBarChange = function(t) {
				var i = this._content.scrollRect;
				if (i) {
					var e = Math.round(t.value);
					t.isVertical ? i.y = e : i.x = e, this._content.conchModel && this._content.conchModel.scrollRect(i.x, i.y, i.width, i.height)
				}
				...
				this._$P.cacheAs || (this._$P.cacheAs = t.prototype._$get_cacheAs.call(this)), t.prototype._$set_cacheAs.call(this, "none"), this._hScrollBar && this._hScrollBar.once("end", this, this.onScrollEnd), this._vScrollBar && this._vScrollBar.once("end", this, this.onScrollEnd)
				...
				null == this._hScrollBar && (laya.display.Node.prototype.addChild.call(this, this._hScrollBar = new q), this._hScrollBar.on("change", this, this.onScrollBarChange, [this._hScrollBar]), this._hScrollBar.target = this._content, this._setScrollChanged()), this._hScrollBar.skin = t
				...
				t.prototype._$set_width.call(this, i), this._setScrollChanged()
			}), n(0, e, "hScrollBar", function() {
				return this._hScrollBar
			}), n(0, e, "content", function() {
				return this._content
			}), n(0, e, "height", t.prototype._$get_height, function(i) {
				t.prototype._$set_height.call(this, i), this._setScrollChanged()
			...
			}), n(0, e, "cacheAs", t.prototype._$get_cacheAs, function(i) {
				t.prototype._$set_cacheAs.call(this, i), this._$P.cacheAs = null, "none" !== i ? (this._hScrollBar && this._hScrollBar.on("start", this, this.onScrollStart), this._vScrollBar && this._vScrollBar.on("start", this, this.onScrollStart)) : (this._hScrollBar && this._hScrollBar.off("start", this, this.onScrollStart), this._vScrollBar && this._vScrollBar.off("start", this, this.onScrollStart))
			}), i
		}(H),
		q = function(t) {
			function i() {
			...
			return h(i, "laya.ui.HScrollBar", t), i.prototype.initialize = function() {
			...
			return e.imps(s, {
				...
				if (-1 != e) {
					...
					if (this.initItems(), this._selectedIndex > -1) {
						var l = 0;
						l = this._selectedIndex < this._items.length ? this._selectedIndex : this._selectedIndex - 1, this._selectedIndex = -1, this.selectedIndex = l
					}
				}
			}, s.initItems = function() {
		...
		Q = function(t) {
			...
			return e.imps(s, {
				...
				if (!s) {
					h = {};
					var l, r = t.attributes;
					for (var a in r) {
						var c = (l = r[a]).nodeName,
							u = l.nodeValue;
				...
				this._dataSource = i, t.prototype._$set_dataSource.call(this, i)
			}), n(0, s, "source", function() {
				return this._source
			}), n(0, s, "scrollBar", function() {
				...
				t.prototype._$set_width.call(this, i), this._list.width = i
			}), n(0, s, "height", t.prototype._$get_height, function(i) {
				t.prototype._$set_height.call(this, i), this._list.height = i
		...
		tt = function(t) {
			...
			return e.imps(s, {
				...
				else for (var i in this._dataSource) this.hasOwnProperty(i) && (this[i] = this._dataSource[i])
			}), n(0, s, "selectedIndex", function() {
				return this._selectedIndex
			}, function(t) {
		...
		et = function(t) {
			...
			}), n(0, e, "inputElementXAdjuster", function() {
				return this._tf.inputElementXAdjuster
			}, function(t) {
				this._tf.inputElementXAdjuster = t
			}), n(0, e, "width", t.prototype._$get_width, function(i) {
				t.prototype._$set_width.call(this, i), this._bg && (this._bg.width = i)
			}), n(0, e, "height", t.prototype._$get_height, function(i) {
				t.prototype._$set_height.call(this, i), this._bg && (this._bg.height = i)
			}), n(0, e, "editable", function() {
				return this._tf.editable
			}, function(t) {
				this._tf.editable = t
			}), n(0, e, "restrict", function() {
				return this._tf.restrict
			}, function(t) {
				this._tf.restrict = t
			}), n(0, e, "prompt", function() {
				return this._tf.prompt
			}, function(t) {
				this._tf.prompt = t
			}), n(0, e, "promptColor", function() {
				return this._tf.promptColor
			}, function(t) {
				this._tf.promptColor = t
			}), n(0, e, "maxChars", function() {
				return this._tf.maxChars
			}, function(t) {
				this._tf.maxChars = t
			}), n(0, e, "focus", function() {
		...
		ht = function(t) {
			...
			}), n(0, e, "isPopup", function() {
				return null != this.parent
			}), n(0, e, "zOrder", t.prototype._$get_zOrder, function(e) {
				t.prototype._$set_zOrder.call(this, e), i.manager._checkMask()
		...
		nt = function(t) {
			...
			return e.sortItem = function(t) {
				...
				this._height != i && (t.prototype._$set_height.call(this, i), this.callLater(this.changeItems))
		...
		ot = function(t) {
			...
			return e.changeItems = function() {
				...
				this._width != i && (t.prototype._$set_width.call(this, i), this.callLater(this.changeItems))
		...
		lt = function(t) {
			...
			return h(i, "laya.ui.RadioGroup", K), i.prototype.createItem = function(t, i) {
				return new J(t, i)
			}, i
		}(),
		rt = function(t) {
			...
			return h(i, "laya.ui.Tab", K), i.prototype.createItem = function(t, i) {
				return new N(t, i)
			}, i
		}(),
		at = function(t) {
			...
			return e.destroy = function(i) {
			...
			}, n(0, e, "scrollY", function() {
				return this._tf.scrollY
			}), n(0, e, "width", t.prototype._$get_width, function(i) {
				t.prototype._$set_width.call(this, i), this.callLater(this.changeScroll)
			}), n(0, e, "hScrollBar", function() {
				return this._hScrollBar
			}), n(0, e, "height", t.prototype._$get_height, function(i) {
				t.prototype._$set_height.call(this, i), this.callLater(this.changeScroll)
			}), n(0, e, "maxScrollX", function() {
				...
				null == this._hScrollBar && (this.addChild(this._hScrollBar = new q), this._hScrollBar.on("change", this, this.onHBarChanged), this._hScrollBar.mouseWheelEnable = !1, this._hScrollBar.target = this._tf, this.callLater(this.changeScroll)), this._hScrollBar.skin = t
			}), n(0, e, "vScrollBar", function() {
				return this._vScrollBar
			}), n(0, e, "maxScrollY", function() {
				return this._tf.maxScrollY
			}), n(0, e, "scrollX", function() {
	...
	function(t) {
		...
		e.createView = function(t) {
			...
			ht.manager.close(this), this.onClose()
